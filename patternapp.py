...
def plot_stock_data(data, price_types):
    ...
    # Loop through each selected price type and plot it
...
if data:
    # Plot the stock data with the selected price types
    plot_stock_data(data, PRICE_TYPES)
